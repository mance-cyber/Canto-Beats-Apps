...
class AppConfig:
    ...
    subtitle_max_chars: int = 20  # Maximum characters per subtitle line (20 for 9:16, 30 for 16:9)
    subtitle_max_gap: float = 0.8  # Maximum gap between segments to merge (seconds)
